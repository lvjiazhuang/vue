<template>
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                 <v-counter :max="40" @on-change="onParamChange('buyNum', $event)"></v-counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
     ...
     <!-- <check-order
      ...
      <my-dialog :is-show="isShowDialog" @on-close="hidePayDialog">
      ...
      <my-dialog :is-show="isShowAfter" @on-close="hidePayDialog">
        感谢参与！！！
      </my-dialog>
  </div>
</template>
